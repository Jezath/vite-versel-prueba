                ...
                <div className='grid p-5 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 bg-slate-700 gap-8' >
                    {
                        projects.map((item, index) => {
                            ...
                            return <div key={index} className='group max-w-sm bg-red-200 bg-cover border-2 relative overflow-hidden'>

                                <div className='group-hover:bg-black/80 w-full h-full absolute z-20 transition-all duration-300'></div>
